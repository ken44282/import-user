...
(def input-file (io/file (.getProperty conf "dir.spool") "test1.csv"))
(def output-file (io/file (.getProperty conf "dir.result") "users.csv"))
...
(deftest a-test
  (testing "insert-test"
    (do
      ...
      (with-open [writer
                  (io/writer (io/file (.getProperty conf "dir.spool")
                                      "test1.csv"))]
      ...
      (is (= [["user1" "USER001" "pass001"]
             ...
             (with-open [reader
                         (io/reader (io/file (.getProperty conf "dir.result")
                                             "users.csv"))]
